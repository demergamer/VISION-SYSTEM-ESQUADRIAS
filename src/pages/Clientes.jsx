    ...
    <PermissionGuard setor="Clientes">
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 font-sans text-slate-900">
        <div className="max-w-[1600px] mx-auto p-6 md:p-8 space-y-8">
          ...
          {/* Widget Serasa */}
          <div className="bg-white border border-red-100 rounded-2xl p-4 shadow-sm flex flex-col sm:flex-row items-center gap-4">
            <div className="flex items-center gap-4 flex-1">
              {/* Logo Serasa Experian */}
              <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden bg-white border border-slate-100 shadow-sm p-1">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Serasa_Experian_logo.svg/320px-Serasa_Experian_logo.svg.png"
                  alt="Serasa Experian"
                  className="w-full h-full object-contain"
                  onError={(e) => {
                    e.target.style.display = 'none';
                    e.target.parentElement.innerHTML = '<span class="text-red-600 font-black text-xl">S</span>';
                  }}
                />
              </div>
              <div>
                <h3 className="font-bold text-slate-800 text-base leading-tight">Consulta Serasa PF/PJ</h3>
                <p className="text-xs text-slate-500 mt-0.5">Acesse o relatório básico e análise de crédito em nova aba.</p>
              </div>
            </div>
            <a
              ...
              className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-semibold text-sm px-5 py-2.5 rounded-xl shadow transition-colors whitespace-nowrap flex-shrink-0"
            >
