  ...
  return (
    (<div
      ...
      <div
        ...
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar/95 backdrop-blur supports-[backdrop-filter]:bg-sidebar/60 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow">
          {children}
        </div>
      </div>
    </div>)
