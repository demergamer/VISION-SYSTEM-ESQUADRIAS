...
function gerarHTMLRelatorio(empresa, contasSelecionadas, dataInicio, dataFim, usuarioNome) {
...
<body>
  <div class="header">
    ...
    <div class="header-right">
      ...
      <div class="emitido-por">Emitido por: <strong>${usuarioNome || 'Sistema'}</strong></div>
...
export default function RelatorioContabilModal({ open, onClose, empresas, contasTodas }) {
  ...
  const gerarPDF = () => {
    ...
    const html = gerarHTMLRelatorio(empresa, contasParaImprimir, dataInicio, dataFim, user?.full_name || 'Sistema');
