      ...
      <div className="max-w-[1400px] mx-auto px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-extrabold text-white text-lg leading-tight">Loja B2B/B2C</h3>
        ...
        <div className="border-t border-slate-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-slate-500 text-xs">
            © {new Date().getFullYear()} Loja B2B/B2C. Todos os direitos reservados.
          </p>
          <div className="flex items-center gap-4">
            <span className="text-slate-500 text-xs">CNPJ: 00.000.000/0001-00</span>
